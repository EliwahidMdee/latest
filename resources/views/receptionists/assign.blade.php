...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('receptionists.assignPatient') }}" method="POST" style="background: #f8f9fa; padding: 30px; border-radius: 10px; box-shadow: 0 4px 15px rgba(0, 0, 0, 0.2); color: #333;">
            @csrf
